...
/**
 * Marks a user record or class for generation of a reflection-free SKIS projection mapper.
 *
 ...
 * type-use annotation must be accessible from the generated {@code .skis} subpackage.
 */
@Documented
